...
function GenerateQuadsBricks(atlas)
    --new code to generate not only the bricks we have but also a key brick
    local tableBricks = table.slice(GenerateQuads(atlas, 32, 16), 1, 24)

    --move key brick to the table of bricks
    tableBricks[22] = tableBricks[24]

    --remove nonusable slots of bricks
    table.remove(tableBricks, 24)
    table.remove(tableBricks, 23)
    return tableBricks
end
