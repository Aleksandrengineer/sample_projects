...
function love.load()
    ...
    gSounds = {
        ...
        --two new sounds for the powerups
        ['powerup-appear'] = love.audio.newSource('sounds/powerup_appear.wav', 'static'),
        ['powerup-get'] = love.audio.newSource('sounds/powerup_get.wav', 'static'),
