...
function StartState:render()
    ...
    love.graphics.setColor(love.math.colorFromBytes(255, 255, 255, self.transitionAlpha))
    love.graphics.rectangle('fill', 0, 0, VIRTUAL_WIDTH, VIRTUAL_HEIGHT)
end
...
function StartState:drawMatch3Text(y)
    ...
    for i = 1, 6 do
        love.graphics.setColor(love.math.colorFromBytes(self.colors[i]))
...
function StartState:drawOptions(y)
    ...
    if self.currentMenuItem == 1 then
        ...
        love.graphics.setColor(love.math.colorFromBytes(48, 96, 130, 255))
    end
